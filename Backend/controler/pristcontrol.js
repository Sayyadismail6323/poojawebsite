...
const shopownercontrol ={
    register:async (req,res)=>{
        ...
        try{
            console.log('post')
            const {name,lastname,phone,email,password,shopname,addr,zip} = req.body; 
            ...
            const newuser  = new Users({
                name,lastname,phone,email,password:passwordhash,shopname,addr,zip
            })
            console.log(newuser)
    ...
    redata:async (req,res) =>{
        console.log("readd")
        try{
           const {name,lastname,age,phone,gst,bank,ifsc,zip,addr} = await req.body;
            const shopowner  = await Users.findByIdAndUpdate({"_id":req.user.id},{"name":name,"lastname":lastname,"phone":phone,"age":age,"gst":gst,"ifsc":ifsc,"bank":bank,"addr":addr,"zip":zip}) 
            console.log(addr)
            console.log(shopowner)
            shopowner.save()
            res.json({shopowner})
